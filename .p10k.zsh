# Generated by Powerlevel10k configuration wizard on 2021-07-20 at 15:42 EDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_ICON="%{$fg_bold[yellow]%}⚡"
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_SHOW_ON_COMMAND='kubectl|helm|kubens|kubectx|oc|istioctl|kogito|k9s|helmfile|flux|fluxctl|stern|kcsc|kcns'
...
# Place prompt at the bottom of the terminal on new windows
