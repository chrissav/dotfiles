# Generated by Powerlevel10k configuration wizard on 2022-06-15 at 16:08 EDT.
...
# full frame, compact, few icons, concise, instant_prompt=quiet.
...
() {
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_SHOW_ON_COMMAND='kubectl|helm|kubens|kubectx|oc|istioctl|kogito|k9s|helmfile|flux|fluxctl|stern|kubeseal|skaffold|kc|kubecolor'
